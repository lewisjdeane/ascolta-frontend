...
interface ConversationCardProps {
    conversation: ApiResponseLibraryElement
}

const ConversationCard: React.FC<ConversationCardProps> = ({ conversation }) => {
    return (
        <div className="relative mb-3 flex items-center space-x-3 rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
            <div className="flex-shrink-0">
                <img className="h-16 w-16 rounded-full inline" src={conversation.characters[0].avatar_url} alt="" />
                <img
