    ...
    return (
        <div className="mt-8 rounded overflow-hidden shadow-lg">
            <div className="px-6 py-4">
                <div className="font-bold text-xl mb-2">Chat with an AI language teacher</div>
                        ...
                        .map((language) => (
                            ...
                            >
                                ...
                                <div className="min-w-0 flex-1">
                                    <Link to={`/live/${language.code}`}>
                                        <span className="absolute inset-0" aria-hidden="true" />
                                        <p className="text-md font-medium text-gray-900">{language.option}</p>
                                        {/* <p className="truncate text-sm text-gray-500">5 teachers</p> */}
                                    </Link>
                                </div>
                            </div>
                        ))}
